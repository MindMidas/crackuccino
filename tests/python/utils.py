...
# project root with compiled binaries (encrypt, decrypt-serial, decrypt-mpi)
SRC_DIR: pathlib.Path = PROJ_ROOT;

# bundled dictionaries
ENGLISH_DICT_PATH: pathlib.Path = PROJ_ROOT / "dictionaries" / "american_english_dictionary";
CUSTOM_DICT_PATH: pathlib.Path = PROJ_ROOT / "dictionaries" / "small_dictionary";
